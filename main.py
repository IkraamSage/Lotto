...
lbl_name = Label(root, text="Enter Name:", font=("MS sans serif", 20), fg="black", bg="yellow")
lbl_name.place(x=50, y=150)

txt_name = Entry(root)
txt_name.place(x=300, y=150)

lbl_email = Label(root, text="Email:", font=("MS sans serif", 20), fg="black", bg="yellow")
lbl_email.place(x=50, y=200)

txt_email = Entry(root)
txt_email.place(x=300, y=200)

address = Label(root, text="Address:", font=("MS sans serif", 20), fg="black", bg="yellow")
address.place(x=50, y=250)

address_entry = Entry(root)
address_entry.place(x=300, y=250)

id_number = Label(root, text="ID number:", font=("MS sans serif", 20), fg="black", bg="yellow")
